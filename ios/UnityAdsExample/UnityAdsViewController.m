...
- (void)changePhase:(int)newPhase
{
    ...
    switch (currentPhase) {
        case 1:
            [buttonView setBackgroundImage:[UIImage imageNamed:@"ios_unityads_startscreen.png"] forState:UIControlStateNormal];
            break;
        case 2:
            [buttonView setBackgroundImage:[UIImage imageNamed:@"ios_unityads_playscreen.png"] forState:UIControlStateNormal];
            break;
        case 3:
            [self playVideo];
            break;
        case 4:
            [buttonView setBackgroundImage:[UIImage imageNamed:@"ios_unityads_dowloadscreen.png"] forState:UIControlStateNormal];
            break;
        default:
            break;
    }   

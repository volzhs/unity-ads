...
public class GenerateUnityApi {
  ...
  public static void main(String[] argsArray) throws Exception {
    ...
    PrintWriter sourceWriter = new PrintWriter("gen/UnityAdsAndroidBridge.cpp", "UTF-8");
    PrintWriter headerWriter = new PrintWriter("gen/UnityAdsAndroidBridge.h", "UTF-8");

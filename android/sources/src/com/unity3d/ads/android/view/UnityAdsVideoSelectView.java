...
public class UnityAdsVideoSelectView extends FrameLayout {

	public UnityAdsVideoSelectView(Context context) {
		super(context);
		createView();
	}

	public UnityAdsVideoSelectView(Context context, AttributeSet attrs) {
		super(context, attrs);
		createView();
	}
